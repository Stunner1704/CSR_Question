"""
Django settings for csr_project project.
...
SECRET_KEY = 'django-insecure-u3yg4e7c5q&&qz8il%dlihiz4^f&cod05fp&ze%r9%=)vvk&xi'
...
WSGI_APPLICATION = 'csr_project.wsgi.application'
